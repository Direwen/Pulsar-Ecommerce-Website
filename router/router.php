...
function routeToController($uri, $routes)
{
    ...
    if (array_key_exists($uri, $routes)) {
        ...
        global $DB_METADATA, $root_directory, $error_handler, $user_model, $category_model, $product_model, $variant_model, $inventory_model, $order_model, $order_variant_model, $address_model, $discount_model;
