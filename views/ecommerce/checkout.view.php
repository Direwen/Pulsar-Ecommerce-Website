<div class="py-12 pt-24 px-4 lg:px-10 flex flex-col lg:flex-row lg:flex-row-reverse lg:h-screen">
                ...
                <section class="flex justify-between items-start gap-1">
                    ...
                    <section class="flex justify-start items-center gap-4">
                        ...
                        <section class="flex flex-col items-start justify-center text-dark grow">
                            <span class="text-xl text-wrap"><?= ucwords(htmlspecialchars($item["product_name"])); ?></span>
        ...
        <div class="w-full md:w-8/12 mx-auto space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email"
                    class="border border-light-dark w-full px-4 py-2 rounded focus:outline-accent" placeholder="Email">
            </div>
            ...
            <div>
                ...
                <div class="mt-4 space-y-4">
                    <!-- Country Selector -->
                    <select name="delivery[country]" onchange="updateShippingAndTotal(this)"
                    ...
                    <div class="flex gap-4">
                        <input type="text" name="delivery[first_name]"
                            class="border border-light-dark w-1/2 px-4 py-2 rounded focus:outline-accent"
                            placeholder="First name">
                        <input type="text" name="delivery[last_name]"
                            class="border border-light-dark w-1/2 px-4 py-2 rounded focus:outline-accent"
                    ...
                    <div class="flex gap-4">
                        <input type="text" name="delivery[postal_code]"
                            class="border border-light-dark w-1/2 px-4 py-2 rounded focus:outline-accent"
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="payment-option border border-light-gray rounded-b cursor-pointer">
                        <section class="flex justify-between items-center px-4 py-2">
                            <span>
                                <input type="radio" name="payment[method]" value="paymentwall" class="align-middle mr-1"
                                    disabled>All Payment Methods (by Paymentwall)
                            </span>
                            <img class="w-32 h-8"
            ...
            <div>
                ...
                <div class="billing-option px-4 py-2 border border-light-gray rounded-t cursor-pointer">
                    <span>
                        <input type="radio" name="billing[same_as_shipping]" value="yes" class="align-middle mr-1">Same
                        as shipping address
                    </span>
                </div>
                ...
                <div class="billing-option px-4 py-2 border border-light-gray rounded-b cursor-pointer">
                    <section>
                        <input type="radio" name="billing[same_as_shipping]" value="no" class="align-middle mr-1">Use a
